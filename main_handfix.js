...
class CreateSnippetModal extends obsidian.Modal {
  ...
  display(focus) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const fileTitleValue = new obsidian.TextComponent(
        fileTitleSetting.controlEl,
      );
      fileTitleSetting
      ...
      const cssStylesValue = new obsidian.TextAreaComponent(
        cssStylesSetting.controlEl,
      );
        ...
        __awaiter(this, void 0, void 0, function* () {
          ...
          if (fileName) {
            if (!customCss.snippets.includes(fileName)) {
              yield app.vault.create(
                `${customCss.getSnippetsFolder()}/${fileName}.css`,
                fileContents,
              );
              console.log(
                `%c"${fileName}.css" has been created!`,
                "color: Violet",
              );
              ...
              this.close();
            } else new obsidian.Notice(`"${fileName}.css" already exists.`);
          } else new obsidian.Notice("Missing name for file");
        });
  ...
  if (!menuExists) {
    ...
    menuDom.addEventListener(
      ...
      (e) => {
        if (
          e.target &&
          (e.target.closest(".MS-OpenSnippet") ||
            e.target.closest(".MySnippetsButton"))
        )
          return;
        e.stopPropagation();
      },
    ...
    currentSnippets.forEach((snippet) => {
      ...
      menu.addItem((snippetElement) => {
        ...
        snippetElementDom.addEventListener("mouseenter", () => {
          isMouseOverMenu = true;
          if (closeTimeout) {
            clearTimeout(closeTimeout);
            closeTimeout = null;
        ...
        snippetElementDom.addEventListener("mouseleave", () => {
          isMouseOverMenu = false;
        });
      });
    });
    ...
    menu.addItem((actions) => {
      ...
      actionsDom.addEventListener("mouseenter", () => {
        isMouseOverMenu = true;
        if (closeTimeout) {
          clearTimeout(closeTimeout);
          closeTimeout = null;
      ...
      actionsDom.addEventListener("mouseleave", () => {
        isMouseOverMenu = false;
      });
    });
...
const icons = {
  ...
  "ms-save": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="white" stroke-width="0" stroke-linecap="round" stroke-linejoin="round"><path d="M5 21h14a2 2 0 0 0 2-2V8h2V6h-4V5a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v2H3v2h2zM9 4h2v8H9zM8 8h9v12H7V8z" fill="white"/></svg>`,
...
class MySnippetsSettingTab extends obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) => {
        toggle.setValue(this.plugin.settings.aestheticStyle).onChange((value) =>
          __awaiter(this, void 0, void 0, function* () {
    ...
    const stylingTemplateContent = new obsidian.TextAreaComponent(
